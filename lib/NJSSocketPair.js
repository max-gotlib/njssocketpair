...
const debuglog = util.debuglog('SocketPair');
...
class SocketPair {
    ...
    /**
     * Process incoming data, received by pipe socket and collect 4-byte buffer. This buffer carries local socket handle (file descriptor) value and will be used for local-remote sockets coupling.
     *
